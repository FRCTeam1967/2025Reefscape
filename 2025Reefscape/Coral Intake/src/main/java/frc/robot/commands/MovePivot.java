...
public class MovePivot extends Command {
    ...
    // Add requirements to ensure that only one command can use the subsystem at a time
    private void addRequirements(Pivot pivot) {
        // Implementation for adding requirements (if needed)
        // This typically involves tracking which commands are using which subsystems.
        // You may need to implement a mechanism to track this if you're not using CommandBase.
    }
}