...
public class TunerConstants {
    ...
    private static final Matrix<N3, N1> visionStDev = VecBuilder.fill(0,0,0);
    private static final Matrix<N3, N1> odometryStDev = VecBuilder.fill(0,0,0);
    public static CommandSwerveDrivetrain createDrivetrain() {//potentially caused odometry issues ;)
